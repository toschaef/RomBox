          ...
          <div className="flex flex-wrap justify-end items-center gap-2 w-full">
            ...
            <div className="flex bg-bg-secondary rounded-lg p-1 border border-border-subtle">
              ...
              <button
                ...
                className={`p-2 hover:bg-bg-muted rounded-md transition-colors disabled:opacity-50 disabled:hover:bg-transparent ${
                  isDefault ? "text-accent-primary" : "text-accent-secondary hover:text-accent-primary"
                }`}
              >
