...
import { getSDLDeviceIndex, parseSDLDeviceIndex } from "../../../../src/main/emulators/duckstation/schema";
import { DOLPHIN } from "../../../../src/main/emulators/dolphin/schema";
  ...
  describe("2. Multi-Controller SDL Device Indices", () => {
    ...
    it.skip("should format multi-controller device indices across all SDL-capable translators", () => {
      ...
      for (const devIdx of [0, 1, 2]) {
        ...
        const melonPatches = melonTranslator.translate({ ...profile, melonJoystickId: devIdx }, ctx);
